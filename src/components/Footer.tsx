  ...
  return (
    <footer className="bg-black border-t border-white/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-14 md:pt-20 pb-10 sm:pb-14 md:pb-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-8 pb-8 sm:pb-10 md:pb-12 border-b border-white/10">
          ...
          <div className="flex gap-4 sm:gap-5 flex-wrap justify-center sm:justify-end items-center">
            <a
        ...
        {/* Links grid: Pages, Legal, Get in Touch */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 items-stretch pt-10 sm:pt-12 justify-items-center lg:justify-items-start">
          {/* Pages */}
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10 text-center px-2">
